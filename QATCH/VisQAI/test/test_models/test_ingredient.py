...
class TestIngredientBase(unittest.TestCase):
    ...
    def test_to_dict_and_from_dict(self):
        ...
        d = ing.to_dict()
        self.assertEqual(d, {"enc_id": 7, "name": "Z", "type": "Ingredient", "user?": True})
...
class TestProtein(unittest.TestCase):
    ...
    def test_invalid_molecular_weight_negative(self):
        ...
        with self.assertRaises(ValueError):
            Protein(
                1, "P", molecular_weight=-1, pI_mean=7, pI_range=1, class_type=ProteinClass.MAB_IGG1
            )
...
class TestSimpleSubclasses(unittest.TestCase):
    ...
    def test_excipient_to_dict(self):
        ...
        d = e.to_dict()
        self.assertEqual(d, {"enc_id": 20, "name": "Sucrose", "type": "Excipient", "user?": True})
