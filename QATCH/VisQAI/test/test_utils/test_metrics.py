...
class TestMetrics(unittest.TestCase):
    ...
    def test_compute_overall_with_invalid_metric(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            results = self.metrics.compute_overall(self.simple_df, metrics=["invalid_metric"])
    ...
    def test_compute_per_shear_rate(self):
        ...
        metrics_list = ["mae", "rmse"]
        results = self.metrics.compute_per_shear_rate(self.simple_df, metrics=metrics_list)
    ...
    def test_bootstrap_ci(self):
        ...
        ci_low, ci_high = self.metrics._bootstrap_ci(self.simple_df, "mae", n_bootstrap=100)
    ...
    def test_all_metrics_callable(self):
        ...
        for metric_name, metric_func in self.metrics.metrics.items():
            self.assertTrue(callable(metric_func), f"Metric '{metric_name}' is not callable")
