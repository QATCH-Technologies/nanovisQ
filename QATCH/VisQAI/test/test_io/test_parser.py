...
from src.models.ingredient import Buffer, Protein, Salt, Stabilizer, Surfactant
...
<run_info>
  <params>
    ...
    def test_get_param_attr_existing(self):
        ...
        """
        units = self.parser.get_param_attr("protein_concentration", "units", required=True)
    ...
    def test_get_param_attr_no_params(self):
        ...
        """
        no_params_file = tempfile.NamedTemporaryFile(mode="w", delete=False, suffix=".xml")
