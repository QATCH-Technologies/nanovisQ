...
where the spacing log-likelihood comes from the learned QModelVoltaSpacingPrior. This is
...
QModelVoltaSpacingPrior.composed_stat, not against the first gap's stats.
...
def _score_config(
    ...
    * A spacing likelihood term from the learned prior.
    ...
    Notes:
        ...
        :meth:`QModelVoltaSpacingPrior.gap_loglik_scoped`, ensuring that partial
...
def _dp_pass(
    ...
    Args:
        ...
        prior: Learned spacing prior
            (:class:`QModelVoltaSpacingPrior`) used for likelihood and
...
def dp_decode(
    ...
    * Optional hard feasibility constraints on gap bounds
    ...
    Args:
        ...
        prior: Learned spacing prior
            (:class:`QModelVoltaSpacingPrior`) used for scoring.
        lam: Weight applied to spacing log-likelihood.
