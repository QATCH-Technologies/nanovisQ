"""
volta_qmodel_yolo_spacing_prior.py
...
class QModelVoltaSpacingPrior:
    ...
    def fit(
        ...
        Returns:
            A fitted `QModelVoltaSpacingPrior` instance containing
    ...
    @staticmethod
    def load(path: Path) -> "QModelVoltaSpacingPrior":
        """Load a serialized spacing prior from disk.

        Deserializes a previously saved :class:`QModelVoltaSpacingPrior`
        ...
        Returns:
            A fully reconstructed `QModelVoltaSpacingPrior` instance with
