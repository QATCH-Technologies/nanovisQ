...
try:
    ...
    from QATCH.QModel.models.static_v4_fusion.v4_fusion_partial_fill import PartialFillDetector
...
class QModelV4Fusion:
    ...
    def visualize(self, figsize: Tuple[int, int] = (16, 12), save_path: Optional[str] = None):
        ...
        ax_main.set_title("V4 Fusion - All POI Detections", fontsize=14, fontweight="bold")
        ...
        # Overall title
        fig.suptitle(
            "V4 Fusion System - Complete POI Detection Analysis",
            fontsize=16,
            fontweight="bold",
            y=0.995,
        )
