...
the production predictor (QModelV7Config.RENDER_VERSION). The render the
...
try:
    from QATCH.QModel.models.qmodel_v7.v7_yolo_dataprocessor import (
        QModelV7DataProcessor as DP,
    )
except (ImportError, ModuleNotFoundError):
    from v7_yolo_dataprocessor import QModelV7DataProcessor as DP
