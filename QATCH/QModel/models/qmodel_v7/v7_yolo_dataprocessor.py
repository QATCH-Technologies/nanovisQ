"""
v7_yolo_dataprocessor.py

This module provides the data preprocessing and visualization logic required for the
QModel V7 YOLO pipeline. It handles the transformation of raw sensor CSV data into
...
class QModelV7DataProcessor:
    ...
    def convert_to_dataframe(worker: Any) -> pd.DataFrame:
        ...
        df = pd.DataFrame(
            {
                QModelV7DataProcessor.COL_TIME: t_raw,
                QModelV7DataProcessor.COL_FREQ: freq_raw,
                QModelV7DataProcessor.COL_DISS: diss_raw,
            }
        )
