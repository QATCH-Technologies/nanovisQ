...
class Constants:
    ...
    max_drift_l_hz = 10000
    # allowed frequency drift RIGHT from initial peak detection (in Hz)
    max_drift_r_hz = 10000
    # how far left-and-right of peak to track (in dB) before switching
    track_width_db = -1.25
    ...
    list_predict_models = ["ModelData",
                           ...
                           "QModel v3a",
                           "QModel v3b"]
    QModel3b_predict = False  # not yet implemented
    QModel3a_predict = False  # not yet implemented
    ...
    # super large number (always use dissipation method)
    freq_delta_5MHz = calibration_frequency_stop
