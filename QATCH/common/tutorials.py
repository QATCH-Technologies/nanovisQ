TutorialPages = {
    ...
    7.3: ("Select Precise Fill Point 3", "The third point in the dataset corresponds to the post-fill point, after the signal has stabilized from the sudden spikes of the initial fill region. This point is often just a few samples after Point 2."),  # hidden POI3
    7.4: ("Select Precise Fill Point 3", "The third point in the dataset corresponds to the 1st channel fill point, which corresponds to the first inflecion point of the three channnel fill regions. See Note below."),
    7.5: ("Select Precise Fill Point 4", "The fourth point in the dataset corresponds to the 2nd channel fill point, which corresponds to the 2nd inflecion point of the three channnel fill regions. See Note below."),
    7.6: ("Select Precise Fill Point 5", "The fifth point in the dataset corresponds to the 3rd channel fill point, which corresponds to the 3rd inflecion point of the three channnel fill regions, or where the frequencies start to drift quickly away from the stable data region. See Note below."),
