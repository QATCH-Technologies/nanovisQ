...
class Overtone_Switcher_10MHz:
    ...
    def overtone_0(self):
        ...
        name = "fundamental"
        start = self.peak_frequencies[self.arg] - \
            self.calc_distance_left(Constants.max_drift_l_hz)
        stop = self.peak_frequencies[self.arg] + \
            self.calc_distance_right(Constants.max_drift_r_hz)
