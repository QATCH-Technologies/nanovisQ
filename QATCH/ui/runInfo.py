...
class QueryRunInfo(QtWidgets.QWidget):
    ...
    def update_run_name(self, previous_xml_path: str, new_name: str, date: datetime.date, secure: bool = False):
        ...
        try:
            ...
            # TODO: normalize and compare names to either all upper case or all lower case.  If normalized match
            # but strmp do not match, write new name allowing rename to occur.  os.path.exists() is case insensitive.
