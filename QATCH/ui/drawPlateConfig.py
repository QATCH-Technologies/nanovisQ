...
from PyQt5.QtWidgets import QApplication, QDialog, QVBoxLayout, QHBoxLayout, QPushButton, QWidget, QMessageBox, QDesktopWidget, QMainWindow
import json
import os
import sys
...
class WellPlate(QDialog):
    press_position = None
    clicked = pyqtSignal(int, int)

    def __init__(self, well_cols: int = 4, well_rows: int = 1, num_devs_available: int = 0):
        super().__init__()
    ...
    def mouseReleaseEvent(self, event):
        ...
        if (self.press_position is not None and
            ...
            self.clicked.emit(self.press_position.x(), self.press_position.y())
